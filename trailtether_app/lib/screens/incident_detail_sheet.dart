    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          content: Text('Report verified. Thank you.', style: TT.body(size: 13)),
        ),
      );
    } catch (e) {
      if (!mounted) return;
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(label,
                    style:
                        TT.label(size: 10, color: TT.text3, letterSpacing: 1.4)),
