          ...
          children: [
                      ...
                      Wrap(
                        ...
                        children: [
                          ...
                          if (cave.elevationM > 0)
                            TTPill(
                              label: units
                                  .formatElevation(cave.elevationM)
                                  .toUpperCase(),
              ...
              onTap: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    ...
                    content:
                        Text('Coordinates copied', style: TT.body(size: 13)),
            ...
            if (linked.isNotEmpty) ...[
              ...
              Text('HIKING ROUTES TO THIS CAVE',
                  style: TT.label(
                      size: 10.5, color: TT.text2, letterSpacing: 1.6)),
              const SizedBox(height: 10),
...
class _CheckInButtonState extends State<_CheckInButton> {
  ...
  Future<void> _checkIn() async {
    ...
    try {
      ...
      LoggerService.error('CAVE_CHECKIN', 'verify/check-in failed: $e', stack);
      if (!mounted) return;
      setState(() {
        _success = false;
